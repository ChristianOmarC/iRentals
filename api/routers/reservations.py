...
from models import ReservationIn, ReservationOut, ReservationList
...
def create_reservation(
    ...
    new_reservation = reservations_repo.create(
        reservation=reservation_in,
        guest_id=account_data["id"]
    )
...
def update_reservation(
    ...
    updated_reservation = reservations_repo.update(
        reservation_id,
        reservation_update
    )
...
def list_reservations_by_account(
    ...
    return ReservationList(
        reservations=reservations_repo.get_all(
            guest_id=account_data['id']
        )
    )
